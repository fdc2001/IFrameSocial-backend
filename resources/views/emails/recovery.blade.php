                ...
                <tr>
                    <td align="center" valign="top" width="100%" style="width: 100%; min-width: 100%;">
                        <table cellpadding="12" border="0" cellspacing="0" width="100%" bgcolor="#ff7a59" style="width: 100%; min-width:100%;">
                            <tbody>
                            <tr>
                                <td align="center" valign="middle" width="100%" style="background: linear-gradient(to right, #ff7a59 0%, #ff8f59 100%); width: 100%; padding: 20px; min-width:100%; color: #ffffff">Frame
                                    <span
                        ...
                        <table id="backgroundTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#ffffff" style="width: 100%; min-width: 100%;">
                            ...
                            <tr>
                                <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                                    <table cellpadding="0" border="0" cellspacing="0" width="100%" style="color: #425b76; background-color: ; font-size: 20px; width: 100%; margin: initial; min-width: 100%; ">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding: 0; ">
                                                ...
                                                <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">
                                                    {{__("recoveryPassword.email.subject")}}</h1>
                                    ...
                                    </table><span style="font-weight: 600">{{__('recoveryPassword.email.body1', ['name'=>$user->name])}}</span>
                                    <p style="margin: 0">
                                        {{__('recoveryPassword.email.body2', ['code'=>$user->email_verified_code])}}
                                    </p>
                                    <p style="margin: 0">
                                        {{__('recoveryPassword.email.body3')}}
                                    </p>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                        <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="http://localhost/{{$recovery->token}}" target="_blank" style="border: 1px solid #425b76; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">{{__('recoveryPassword.email.btn')}}</a></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding: 0; ">
                                                <p style="font-size: 14px; margin: 0">
                                                    <a href="#" style="text-decoration: none; color: #00a4bd;">{{__('recoveryPassword.email.body4')}}</a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
