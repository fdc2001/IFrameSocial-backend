                        ...
                        <table id="backgroundTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#ffffff" style="width: 100%; min-width: 100%;">
                            ...
                            <tr>
                                <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding: 0; ">
                                                ...
                                                <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">
                                                    {{__("newActivationCode.email.subject")}}</h1>
                                    ...
                                    </table><span style="font-weight: 600">{{__('newActivationCode.email.body1', ['name'=>$user->name])}}</span>
                                    <p style="margin: 0">
                                        {{__('newActivationCode.email.body2', ['code'=>$user->email_verified_code])}}
                                    </p>
                                    <p style="margin: 0">
                                        {{__('newActivationCode.email.body3')}}
                                    </p>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                                        <tbody>
                                        <tr>
                                        ...
                                        <!--<tr>
                                            <td align="center">
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                        <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="#"
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding: 0; ">
                                                <p style="font-size: 14px; margin: 0">
                                                    <a href="#" style="text-decoration: none; color: #00a4bd;">{{__('newActivationCode.email.body4')}}</a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
